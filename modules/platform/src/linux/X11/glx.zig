...
pub const GLXPixmap = xlib.XID;
pub const GLXDrawable = xlib.XID;
pub const struct___GLXFBConfigRec = opaque {};
pub const GLXFBConfig = ?*struct___GLXFBConfigRec;
pub const GLXFBConfigID = xlib.XID;
pub const GLXContextID = xlib.XID;
pub const GLXWindow = xlib.XID;
pub const GLXPbuffer = xlib.XID;
pub extern fn glXChooseVisual(dpy: [*c]xlib.Display, screen: c_int, attribList: [*c]c_int) [*c]xlib.XVisualInfo;
pub extern fn glXCreateContext(dpy: [*c]xlib.Display, vis: [*c]xlib.XVisualInfo, shareList: GLXContext, direct: xlib.Bool) GLXContext;
pub extern fn glXDestroyContext(dpy: [*c]xlib.Display, ctx: GLXContext) void;
pub extern fn glXMakeCurrent(dpy: [*c]xlib.Display, drawable: GLXDrawable, ctx: GLXContext) xlib.Bool;
pub extern fn glXCopyContext(dpy: [*c]xlib.Display, src: GLXContext, dst: GLXContext, mask: c_ulong) void;
pub extern fn glXSwapBuffers(dpy: [*c]xlib.Display, drawable: GLXDrawable) void;
pub extern fn glXCreateGLXPixmap(dpy: [*c]xlib.Display, visual: [*c]xlib.XVisualInfo, pixmap: xlib.Pixmap) GLXPixmap;
pub extern fn glXDestroyGLXPixmap(dpy: [*c]xlib.Display, pixmap: GLXPixmap) void;
pub extern fn glXQueryExtension(dpy: [*c]xlib.Display, errorb: [*c]c_int, event: [*c]c_int) xlib.Bool;
pub extern fn glXQueryVersion(dpy: [*c]xlib.Display, maj: [*c]c_int, min: [*c]c_int) xlib.Bool;
pub extern fn glXIsDirect(dpy: [*c]xlib.Display, ctx: GLXContext) xlib.Bool;
pub extern fn glXGetConfig(dpy: [*c]xlib.Display, visual: [*c]xlib.XVisualInfo, attrib: c_int, value: [*c]c_int) c_int;
...
pub extern fn glXGetCurrentDisplay() [*c]xlib.Display;
pub extern fn glXChooseFBConfig(dpy: [*c]xlib.Display, screen: c_int, attribList: [*c]const c_int, nitems: [*c]c_int) [*c]GLXFBConfig;
pub extern fn glXGetFBConfigAttrib(dpy: [*c]xlib.Display, config: GLXFBConfig, attribute: c_int, value: [*c]c_int) c_int;
pub extern fn glXGetFBConfigs(dpy: [*c]xlib.Display, screen: c_int, nelements: [*c]c_int) [*c]GLXFBConfig;
pub extern fn glXGetVisualFromFBConfig(dpy: [*c]xlib.Display, config: GLXFBConfig) [*c]xlib.XVisualInfo;
pub extern fn glXCreateWindow(dpy: [*c]xlib.Display, config: GLXFBConfig, win: xlib.Window, attribList: [*c]const c_int) GLXWindow;
pub extern fn glXDestroyWindow(dpy: [*c]xlib.Display, window: GLXWindow) void;
pub extern fn glXCreatePixmap(dpy: [*c]xlib.Display, config: GLXFBConfig, pixmap: xlib.Pixmap, attribList: [*c]const c_int) GLXPixmap;
pub extern fn glXDestroyPixmap(dpy: [*c]xlib.Display, pixmap: GLXPixmap) void;
pub extern fn glXCreatePbuffer(dpy: [*c]xlib.Display, config: GLXFBConfig, attribList: [*c]const c_int) GLXPbuffer;
pub extern fn glXDestroyPbuffer(dpy: [*c]xlib.Display, pbuf: GLXPbuffer) void;
pub extern fn glXQueryDrawable(dpy: [*c]xlib.Display, draw: GLXDrawable, attribute: c_int, value: [*c]c_uint) void;
pub extern fn glXCreateNewContext(dpy: [*c]xlib.Display, config: GLXFBConfig, renderType: c_int, shareList: GLXContext, direct: xlib.Bool) GLXContext;
pub extern fn glXMakeContextCurrent(dpy: [*c]xlib.Display, draw: GLXDrawable, read: GLXDrawable, ctx: GLXContext) xlib.Bool;
pub extern fn glXGetCurrentReadDrawable() GLXDrawable;
pub extern fn glXQueryContext(dpy: [*c]xlib.Display, ctx: GLXContext, attribute: c_int, value: [*c]c_int) c_int;
pub extern fn glXSelectEvent(dpy: [*c]xlib.Display, drawable: GLXDrawable, mask: c_ulong) void;
pub extern fn glXGetSelectedEvent(dpy: [*c]xlib.Display, drawable: GLXDrawable, mask: [*c]c_ulong) void;
pub const PFNGLXGETFBCONFIGSPROC = ?fn ([*c]xlib.Display, c_int, [*c]c_int) callconv(.C) [*c]GLXFBConfig;
pub const PFNGLXCHOOSEFBCONFIGPROC = ?fn ([*c]xlib.Display, c_int, [*c]const c_int, [*c]c_int) callconv(.C) [*c]GLXFBConfig;
pub const PFNGLXGETFBCONFIGATTRIBPROC = ?fn ([*c]xlib.Display, GLXFBConfig, c_int, [*c]c_int) callconv(.C) c_int;
pub const PFNGLXGETVISUALFROMFBCONFIGPROC = ?fn ([*c]xlib.Display, GLXFBConfig) callconv(.C) [*c]xlib.XVisualInfo;
pub const PFNGLXCREATEWINDOWPROC = ?fn ([*c]xlib.Display, GLXFBConfig, xlib.Window, [*c]const c_int) callconv(.C) GLXWindow;
pub const PFNGLXDESTROYWINDOWPROC = ?fn ([*c]xlib.Display, GLXWindow) callconv(.C) void;
pub const PFNGLXCREATEPIXMAPPROC = ?fn ([*c]xlib.Display, GLXFBConfig, xlib.Pixmap, [*c]const c_int) callconv(.C) GLXPixmap;
pub const PFNGLXDESTROYPIXMAPPROC = ?fn ([*c]xlib.Display, GLXPixmap) callconv(.C) void;
pub const PFNGLXCREATEPBUFFERPROC = ?fn ([*c]xlib.Display, GLXFBConfig, [*c]const c_int) callconv(.C) GLXPbuffer;
pub const PFNGLXDESTROYPBUFFERPROC = ?fn ([*c]xlib.Display, GLXPbuffer) callconv(.C) void;
pub const PFNGLXQUERYDRAWABLEPROC = ?fn ([*c]xlib.Display, GLXDrawable, c_int, [*c]c_uint) callconv(.C) void;
pub const PFNGLXCREATENEWCONTEXTPROC = ?fn ([*c]xlib.Display, GLXFBConfig, c_int, GLXContext, xlib.Bool) callconv(.C) GLXContext;
pub const PFNGLXMAKECONTEXTCURRENTPROC = ?fn ([*c]xlib.Display, GLXDrawable, GLXDrawable, GLXContext) callconv(.C) xlib.Bool;
pub const PFNGLXGETCURRENTREADDRAWABLEPROC = ?fn () callconv(.C) GLXDrawable;
pub const PFNGLXGETCURRENTDISPLAYPROC = ?fn () callconv(.C) [*c]xlib.Display;
pub const PFNGLXQUERYCONTEXTPROC = ?fn ([*c]xlib.Display, GLXContext, c_int, [*c]c_int) callconv(.C) c_int;
pub const PFNGLXSELECTEVENTPROC = ?fn ([*c]xlib.Display, GLXDrawable, c_ulong) callconv(.C) void;
pub const PFNGLXGETSELECTEDEVENTPROC = ?fn ([*c]xlib.Display, GLXDrawable, [*c]c_ulong) callconv(.C) void;
...
pub extern fn glXBindTexImageARB(dpy: [*c]xlib.Display, pbuffer: GLXPbuffer, buffer: c_int) xlib.Bool;
pub extern fn glXReleaseTexImageARB(dpy: [*c]xlib.Display, pbuffer: GLXPbuffer, buffer: c_int) xlib.Bool;
pub extern fn glXDrawableAttribARB(dpy: [*c]xlib.Display, draw: GLXDrawable, attribList: [*c]const c_int) xlib.Bool;
pub extern fn glXGetFrameUsageMESA(dpy: [*c]xlib.Display, drawable: GLXDrawable, usage: [*c]f32) c_int;
pub extern fn glXBeginFrameTrackingMESA(dpy: [*c]xlib.Display, drawable: GLXDrawable) c_int;
pub extern fn glXEndFrameTrackingMESA(dpy: [*c]xlib.Display, drawable: GLXDrawable) c_int;
pub extern fn glXQueryFrameTrackingMESA(dpy: [*c]xlib.Display, drawable: GLXDrawable, swapCount: [*c]i64, missedFrames: [*c]i64, lastMissedUsage: [*c]f32) c_int;
pub const PFNGLXGETFRAMEUSAGEMESAPROC = ?fn ([*c]xlib.Display, GLXDrawable, [*c]f32) callconv(.C) c_int;
pub const PFNGLXBEGINFRAMETRACKINGMESAPROC = ?fn ([*c]xlib.Display, GLXDrawable) callconv(.C) c_int;
pub const PFNGLXENDFRAMETRACKINGMESAPROC = ?fn ([*c]xlib.Display, GLXDrawable) callconv(.C) c_int;
pub const PFNGLXQUERYFRAMETRACKINGMESAPROC = ?fn ([*c]xlib.Display, GLXDrawable, [*c]i64, [*c]i64, [*c]f32) callconv(.C) c_int;
...
pub extern fn glXBindTexImageEXT(dpy: [*c]xlib.Display, drawable: GLXDrawable, buffer: c_int, attrib_list: [*c]const c_int) void;
pub extern fn glXReleaseTexImageEXT(dpy: [*c]xlib.Display, drawable: GLXDrawable, buffer: c_int) void;
pub const GLXPbufferClobberEvent = extern struct {
    event_type: c_int,
    draw_type: c_int,
    serial: c_ulong,
    send_event: xlib.Bool,
    display: [*c]xlib.Display,
...
pub const GLX_CONTEXT_DEBUG_BIT_ARB = @as(c_int, 0x00000001);
pub const GLX_CONTEXT_COMPATIBILITY_PROFILE_BIT_ARB = @as(c_int, 0x00000002);
pub const GLX_CONTEXT_CORE_PROFILE_BIT_ARB = @as(c_int, 0x00000001);
pub const GLX_CONTEXT_PROFILE_MASK_ARB = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x9126, .hexadecimal);
pub const GLX_CONTEXT_FORWARD_COMPATIBLE_BIT_ARB = @as(c_int, 0x00000002);
pub const GLX_CONTEXT_MAJOR_VERSION_ARB = @as(c_int, 0x2091);
pub const GLX_CONTEXT_MINOR_VERSION_ARB = @as(c_int, 0x2092);
pub const GLX_CONTEXT_FLAGS_ARB = @as(c_int, 0x2094);
pub const GLX_CONTEXT_ES2_PROFILE_BIT_EXT = @as(c_int, 0x00000004);
pub const GLX_CONTEXT_ROBUST_ACCESS_BIT_ARB = @as(c_int, 0x00000004);
pub const GLX_LOSE_CONTEXT_ON_RESET_ARB = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x8252, .hexadecimal);
pub const GLX_CONTEXT_RESET_NOTIFICATION_STRATEGY_ARB = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x8256, .hexadecimal);
pub const GLX_NO_RESET_NOTIFICATION_ARB = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x8261, .hexadecimal);
pub const GLX_CONTEXT_RELEASE_BEHAVIOR_ARB = @as(c_int, 0x2097);
pub const GLX_CONTEXT_RELEASE_BEHAVIOR_NONE_ARB = @as(c_int, 0);
pub const GLX_CONTEXT_RELEASE_BEHAVIOR_FLUSH_ARB = @as(c_int, 0x2098);
pub const GLX_CONTEXT_OPENGL_NO_ERROR_ARB = @as(c_int, 0x31b3);
